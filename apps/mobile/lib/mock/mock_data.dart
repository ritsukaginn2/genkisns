...
List<Comment> generateTemplateComments({
  required PostSeed post,
  required List<AiFriend> friends,
  required DateTime now,
}) {
  final selectedFriends = (friends.isEmpty ? presetFriends : friends)
      .take(5)
      .toList();
  final templates = [
  ...
  final videoTemplates = [
    '这段视频好有现场感，会让人想点开看完。',
    '动态比照片更有那个氛围，真的挺适合留在这里。',
    '这个瞬间被录下来是对的，有种小小的闪光感。',
    '我会给这条视频多停几秒，感觉很真实。',
    '视频里的节奏好舒服，像刚好撞见一个好心情。',
  ];
  final activeTemplates = post.images.any((image) => image.isVideo)
      ? videoTemplates
      : templates;
  ...
  return [
    for (var index = 0; index < selectedFriends.length; index++)
      Comment(
        ...
        content: activeTemplates[index % activeTemplates.length],
...
final mockPosts = <Post>[
  Post(
    ...
    images: PostImageRef.previewColors([AppColors.teal, Color(0xFF9BC5FF)]),
    ...
    comments: [
      Comment(
        ...
        actorColor: AppColors.coral,
        content: '这个颜色太适合你了',
        createdAt: DateTime(2026, 5, 10, 14, 28),
      ),
      Comment(
        id: 'c2',
        postId: 'preview_1',
        actorId: 'friend_sen',
        actorNameSnapshot: '森也',
        actorAvatarSnapshot: '森',
        actorColor: AppColors.blue,
        content: '第一张有种安静的光感，很配你。',
        createdAt: DateTime(2026, 5, 10, 14, 35),
      ),
      Comment(
        id: 'c3',
        postId: 'preview_1',
        actorId: 'friend_qiao',
        actorNameSnapshot: '乔乔',
        actorAvatarSnapshot: '乔',
        actorColor: AppColors.teal,
        content: '不发出来才可惜了，必须让我看到。',
        createdAt: DateTime(2026, 5, 10, 14, 52),
      ),
    ],
  ),
  Post(
    ...
    images: PostImageRef.previewColors([Color(0xFFFFB6D1)]),
    ...
    comments: [
      Comment(
        ...
        postId: 'preview_2',
        actorId: 'friend_aki',
        actorNameSnapshot: 'Aki',
        actorAvatarSnapshot: 'A',
        actorColor: AppColors.yellow,
        content: '稳稳的小幸福。',
        createdAt: DateTime(2026, 5, 9, 9, 20),
      ),
    ],
  ),
  Post(
    ...
    images: PostImageRef.previewColors([Color(0xFFFFD166), AppColors.coral]),
    ...
    comments: [
      Comment(
        ...
        postId: 'preview_3',
        actorId: 'friend_lan',
        actorNameSnapshot: '岚姐',
        actorAvatarSnapshot: '岚',
        actorColor: Color(0xFF8E6BBE),
        content: '认真过日子的能量感，爱了。',
        createdAt: DateTime(2026, 5, 8, 20, 15),
      ),
      Comment(
        id: 'c6',
        postId: 'preview_3',
        ...
        actorAvatarSnapshot: '美',
        actorColor: AppColors.coral,
        content: '两小时值了，这种事只有自己懂。',
        createdAt: DateTime(2026, 5, 8, 20, 31),
      ),
    ],
  ),
  Post(
